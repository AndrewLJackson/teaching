...
# Im going to conver to kilograms so we get some numbers less than 1 for this example
...
## Let me tell you about the birds and mammals
...
boxplot(log10(mydata$body) ~ mydata$class)
...
In more general terms, a difference of $\Delta X$ between two numbers on the log10 scale translates into a proportional difference on the raw data scale of $10^{\Delta X}$
